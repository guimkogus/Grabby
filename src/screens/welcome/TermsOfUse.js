      ...
      <View style={styles.container}>
        <View style={styles.textContainer}>
          ...
          <AppText style={styles.text}>
            ...
            elementum orci tortor, at lacinia elit tempus sit amet. Nunc in nunc
            vel erat ullamcorper tempor in sit amet erat. Suspendisse sed lorem
            dui. Interdum et malesuada fames ac ante ipsum primis in faucibus.
            Aliquam tempus ex eget eros sollicitudin accumsan fringilla et nisi.
            Aliquam interdum sem lectus, eget aliquam dolor aliquet non.
          ...
          <AppText style={styles.text}>
            ...
            Pellentesque eu urna at nisl mollis interdum eget id metus. Maecenas
            a nibh congue libero sagittis gravida in eu ipsum. Morbi et rutrum
            ligula, vel suscipit libero. Phasellus vulputate massa lacus, quis
            fermentum erat faucibus a. Praesent sit amet pretium felis. Duis
